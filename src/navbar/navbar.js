...
const socials = [
  { path: `https://reddit.com/r/quin69`, icon: <RedditIcon color="primary" /> },
  { path: `https://www.youtube.com/channel/UCGKQFbHWBL9SqYXH41ZMTkw`, icon: <YouTubeIcon color="primary" /> },
  {
